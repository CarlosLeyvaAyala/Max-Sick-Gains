...
--- @param level number Fitness level as defined in `MaxSickGains.exe`. From obese to athlete.
...
local function GetBlendedMorph(level, gains, slider)
  ...
  local s = ""
  -- ; FIXME: Add proper checks for levels
  ...
  elseif (upperBlendLim <= gains) and (level < 2) then
  ...
  print(level, gains, slider, "r=", r, s)
